...
1. Leverera ett fungerande MVP tidigt i projektet
2. Göra prioriteringarna tydligare om tiden hade tagit slut
3. Hålla arbetet synligt och strukturerat från start till leverans
4. Skapa en tydlig koppling mellan user stories, kod och leverans
